...
def main():
    ...
    while True:
        ...
        if len(payload) >= 8:
            ...
            # Skip past the 8-byte mandatory GTP-U header. If E/S/PN flags
            # are set, 4 more optional bytes follow before the PDCP PDU
            # actually starts; for the typical F1-U case (E=0 S=0 PN=0,
            # as observed in this project's real captures) the PDCP PDU
            # starts immediately at byte 8.
